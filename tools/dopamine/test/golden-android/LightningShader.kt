// @generated by @dopaminefx/build from the web GLSL (effects/lightning/web/src/lightning-shader.ts).
...
val LIGHTNING_VERTEX_SRC: String = """#version 300 es
void main() {
...
uniform vec2  uVerts[120];
uniform vec4  uBoltMeta[8];
