// @generated by @dopaminefx/build from the web GLSL (effects/checkmate/web/src/checkmate-shader.ts).
...
package ai.dopamine.effect.checkmate
...
val CHECKMATE_VERTEX_SRC: String = """#version 300 es
void main() {
...
val CHECKMATE_FRAGMENT_SRC: String = """#version 300 es
