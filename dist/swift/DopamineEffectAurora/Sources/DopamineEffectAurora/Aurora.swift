// @generated by @dopaminefx/build from effects/aurora/aurora.dope.json — do not edit.
//
// Aurora as a Dopamine effect on the Swift backbone — the DATA-DRIVEN factory
// shell. This effect ships NO hand-written Swift: everything that isn't the
// shader lives in aurora.dope.json — the mood→params mapping + OKLCH palette
...
// GLSL by the toolchain; `AuroraUniforms` + `packAuroraUniforms` are generated
// from the `.dope` binding contract.)

import Foundation
import DopamineCore

/// Aurora: resolves a feeling → the flat `.dope` param bag. The drawable side
/// is Metal-only (below).
