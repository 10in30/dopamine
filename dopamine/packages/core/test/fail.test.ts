...
import { parseDope, resolveDopeParams, getOutline } from "../src/framework/loader.js";
import { decodeSdf } from "../src/engine/sdf.js";
import { failEnvelope, stampProgress, shakeOffset } from "../src/engine/tempo.js";
import { hasMood } from "../src/framework/mood-registry.js";
import { loadEffectSync } from "../src/framework/load-effect.js";
// Importing the effect registers its moods + program.
import "../src/effects/fail.js";
