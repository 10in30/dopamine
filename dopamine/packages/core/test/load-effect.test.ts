...
import { resolveDopeParams, parseDope, getOutline } from "../src/framework/loader.js";
import { resolveParams, MAX_MOTES } from "../src/engine/mood.js";
import { oklchToLinearSrgb } from "../src/engine/color.js";
// Importing the effect registers its render program ("solarbloom").
import "../src/effects/solarbloom.js";
