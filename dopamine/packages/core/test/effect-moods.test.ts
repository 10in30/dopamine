...
// Importing the barrel registers all four built-in effects + their moods.
import { builtinEffectNames } from "../src/index.js";
import { getEffect } from "../src/framework/registry.js";
